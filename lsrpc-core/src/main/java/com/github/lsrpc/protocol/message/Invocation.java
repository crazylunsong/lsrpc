...
import com.github.lsrpc.util.generic.GenericMethod;
import com.github.lsrpc.util.generic.GenericType;
import com.github.lsrpc.util.idl.IDLMethodDesc;
import com.github.lsrpc.util.ClassUtils;
...
import static com.github.lsrpc.util.ClassUtils.*;
        ...
        if (parameters.length > 0) {
            ...
            if (argTypes == null || argTypes.length == 0) {
                ...
                for (int i = 0; i < resolvedClasses.length; i++) {
                    ...
                    if (GenericType.validate(resolvedTypes[i], clazz, true)) {
