...
public class MessageHeader implements Header {
    ...
    public io.joyrpc.protocol.message.MessageHeader msgType(int msgType) {
        this.msgType = (byte) msgType;
        return this;
    }
     ...
     * @return 消息头
     */
    public io.joyrpc.protocol.message.MessageHeader addAttribute(final Head key, final Object value) {
     ...
     * @return 消息头
     */
    public io.joyrpc.protocol.message.MessageHeader addAttribute(final Byte key, final Object value) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof io.joyrpc.protocol.message.MessageHeader)) {
            return false;
        }

        io.joyrpc.protocol.message.MessageHeader that = (io.joyrpc.protocol.message.MessageHeader) o;
     ...
     * @return 应答的消息头
     */
    public io.joyrpc.protocol.message.MessageHeader response(final byte msgType) {
     ...
     * @return 应答的消息头
     */
    public io.joyrpc.protocol.message.MessageHeader response(final byte msgType, final byte compression) {
     ...
     * @return 应答消息头
     */
    public io.joyrpc.protocol.message.MessageHeader response(final byte msgType, final byte compression, Map<Byte, Object> attributes) {
        io.joyrpc.protocol.message.MessageHeader result = new io.joyrpc.protocol.message.MessageHeader();
        result.msgId = msgId;
     ...
     * @param header 头
     */
    protected void copy(final io.joyrpc.protocol.message.MessageHeader header) {
        msgId = header.msgId;
     ...
     */
    @Override
    public io.joyrpc.protocol.message.MessageHeader clone() {
        io.joyrpc.protocol.message.MessageHeader result = new io.joyrpc.protocol.message.MessageHeader();
        result.copy(this);
        return result;
    }
