...
public class RequestMessage<T> extends BaseMessage<T> implements Request {
    ...
    public RequestMessage() {
        super(new io.joyrpc.protocol.message.MessageHeader());
    }
     ...
     * @param header 头
     */
    public RequestMessage(io.joyrpc.protocol.message.MessageHeader header) {
        super(header);
    }
     ...
     * @param payload 消息体
     */
    public RequestMessage(io.joyrpc.protocol.message.MessageHeader header, T payload) {
        super(header);
     ...
     * @return 请求消息
     */
    public static io.joyrpc.protocol.message.RequestMessage<io.joyrpc.protocol.message.Invocation> build(final io.joyrpc.protocol.message.Invocation invocation) {
        io.joyrpc.protocol.message.RequestMessage<io.joyrpc.protocol.message.Invocation> request = new io.joyrpc.protocol.message.RequestMessage<>(new io.joyrpc.protocol.message.MessageHeader(MsgType.BizReq.getType()), invocation);
     ...
     * @return 请求消息
     */
    public static io.joyrpc.protocol.message.RequestMessage<io.joyrpc.protocol.message.Invocation> build(final io.joyrpc.protocol.message.Invocation invocation, final Channel channel) {
        return build(new io.joyrpc.protocol.message.MessageHeader(MsgType.BizReq.getType()), invocation, channel.getLocalAddress(), channel.getRemoteAddress());
    }
     ...
     * @return 请求消息
     */
    public static io.joyrpc.protocol.message.RequestMessage<io.joyrpc.protocol.message.Invocation> build(final io.joyrpc.protocol.message.MessageHeader header, final io.joyrpc.protocol.message.Invocation invocation,
        ...
        io.joyrpc.protocol.message.RequestMessage<io.joyrpc.protocol.message.Invocation> result = build(header, invocation, channel.getLocalAddress(), remoteAddress);
    ...
    public static io.joyrpc.protocol.message.RequestMessage<io.joyrpc.protocol.message.Invocation> build(final io.joyrpc.protocol.message.MessageHeader header, final io.joyrpc.protocol.message.Invocation invocation,
        ...
        io.joyrpc.protocol.message.RequestMessage<io.joyrpc.protocol.message.Invocation> request = new io.joyrpc.protocol.message.RequestMessage<>(header, invocation);
        request.createTime = SystemClock.now();
